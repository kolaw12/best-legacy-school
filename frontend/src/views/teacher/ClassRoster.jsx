    ...
    return (
        <>
            <header className="mb-6">
                ...
                <p className="mt-1 text-sm text-gray-500">{rows.length} pupils in {classLevel.name}. Click a name to view a report card.</p>
            </header>
            ...
            <DataTable
                ...
                columns={[
                    ...
                    {
                        key: 'action', label: '',
                        render: r => <Link to={`/admin/report-cards/${r.id}`} className="text-xs font-semibold text-primary hover:underline">View report →</Link>,
                    },
                ]}
            />
        </>
